...
#ifndef MLSDEVICE_H_INCLUDED
#define MLSDEVICE_H_INCLUDED
#ifdef __cplusplus
extern "C"
{
#endif
...
/*!
 * \brief mlsDeviceGetNode - Get node string for device with vendor id and product id and subsystem
 * \param
 ...
 */
const char * mlsDeviceGetNode(const char *devSubsystem, const char *devVendorID, const char *devProductID);


#ifdef __cplusplus
}
#endif
#endif // MLSDEVICE_H_INCLUDED
/**@}*/
